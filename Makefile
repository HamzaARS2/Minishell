...
utils/ft_split.c utils/ft_strchr.c utils/ft_putstr_fd.c utils/ft_strcmp.c utils/ft_isdigit.c

BUILTINS = builtins/builtin_check.c builtins/cd.c builtins/mshell_export.c builtins/builtins_utils.c
