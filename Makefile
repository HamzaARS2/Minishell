...
resolver/resolver_utils_extra.c handler/handler_utils.c

MAIN_FILES = minishell.c lexer/lexer.c lexer/token.c resolver/resolver.c handler/handler.c handler/checker.c $(UTILS)
